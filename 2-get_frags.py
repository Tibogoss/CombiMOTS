...
from utils_fgib.utils import get_load_model, get_custom_loader as get_loader, get_sanitize_error_frags
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--gib_path", type=str, required=True, help="Path to the trained model")
    parser.add_argument("-v", "--vocab_path", type=str, required=True, help="Path to save the fragment vocabulary")
    parser.add_argument("-s", "--vocab_size", type=int, default=300, help="Maximum size of the fragment vocabulary. Returns the top N fragments with the highest scores.")
